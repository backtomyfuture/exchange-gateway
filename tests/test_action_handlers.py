...
from app.models.lark import LarkTaskQueue, LarkApp
...
async def test_email_handler_execute_success(email_handler, mock_context):
    ...
    with patch("app.services.lark.handlers.email_handler.get_email_service") as mock_get_email, \
...
async def test_email_handler_recipient_parsing(email_handler, mock_context):
    ...
    mock_context["record_data"]["To"] = [
        {"id": "ou_123", "name": "User A"}, 
        "manual@example.com"
    ]
